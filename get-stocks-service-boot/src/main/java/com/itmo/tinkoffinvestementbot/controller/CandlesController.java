...
public class CandlesController {
    ...
    public List<CandlesDto> getStockByTickerAndDates(@RequestParam String ticker, @RequestParam String startDate, @RequestParam String endDate, @RequestParam String intervalMin) {
